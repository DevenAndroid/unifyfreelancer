                      ...
                      SizedBox(
                        ...
                        child: Stack(
                          children: List.generate(
                            ...
                            (index11) => Positioned(
                                left: stackButtonsList[index11].positionPoint,
                                child: CustomOutlineButton(
                                  backgroundColor: AppTheme.whiteColor,
                                  textColor: AppTheme.primaryColor,
                                  title: stackButtonsList[index11]
                                      .titleText
                                      .toString(),
                                  onPressed: () {
                                    String titleName = "";
                                    ...
                                    titleName =
                                        stackButtonsList[index11].titleText!;
                                    positionName = stackButtonsList[index11]
                                        .positionPoint!;
                                    stackButtonsList.removeAt(index11);
                                    stackButtonsList.add(StackButtons(
                                        titleText: titleName,
                                        positionPoint: positionName));
                                    setState(() {});
                                  },
                                )),
                          ),
